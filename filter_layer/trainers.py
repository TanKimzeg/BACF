...
class Trainer:
    ...
    def cross_entropy(self, seq_out, pos_ids, neg_ids) -> torch.Tensor:
...
class FMLPRecTrainer(Trainer):
    ...
    def iteration(self, epoch, dataloader, full_sort=False, train=True,output=None):
        ...
        if output is not None:
            ...
            with open(output, 'w') as f:
                for hidden_state in recommends:
                    f.write(' '.join(map(str, hidden_state)) + '\n')
            return
        ...
        if train:
            ...
            for i, batch in rec_data_iter:
                ...
                loss:torch.Tensor = self.cross_entropy(sequence_output, answer, neg_answer)
            ...
            if full_sort:
                ...
                for i, batch in rec_data_iter:
                    ...
                    # recommend_output [batch_size, hidden_size]
